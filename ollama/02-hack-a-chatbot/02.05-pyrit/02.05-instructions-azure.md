...
This v2 script (`02.05-pyrit-playground-2.py`) adds structured result logging, persistent memory, and a review mode -- because running attacks is only half the job. A pen tester who can't review, organize, and explain their findings isn't done yet.
...
```bash
python 02.05-pyrit-playground-2.py --simple --port 4002
```
...
```bash
python 02.05-pyrit-playground-2.py --basic --port 4002
```
...
```bash
python 02.05-pyrit-playground-2.py --redteam --port 4002 -n 2
```
...
```bash
# Review everything
python 02.05-pyrit-playground-2.py --review

# Review only Lab 2 results
python 02.05-pyrit-playground-2.py --review --port 4002
```
